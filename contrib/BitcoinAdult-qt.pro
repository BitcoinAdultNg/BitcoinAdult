...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/BitcoinAdult-cli.cpp \
           src/BitcoinAdult-tx.cpp \
           src/BitcoinAdult.cpp \
           src/db.cpp \
           ...
           src/test/test_BitcoinAdult.cpp \
...
RESOURCES += src/qt/BitcoinAdult.qrc src/qt/BitcoinAdult_locale.qrc

TRANSLATIONS += src/qt/locale/BitcoinAdult_bg.ts \
                src/qt/locale/BitcoinAdult_de.ts \
                src/qt/locale/BitcoinAdult_en.ts \
                src/qt/locale/BitcoinAdult_es.ts \
                src/qt/locale/BitcoinAdult_fi.ts \
                src/qt/locale/BitcoinAdult_fr.ts \
                src/qt/locale/BitcoinAdult_it.ts \
                src/qt/locale/BitcoinAdult_ja.ts \
                src/qt/locale/BitcoinAdult_pl.ts \
                src/qt/locale/BitcoinAdult_pt.ts \
                src/qt/locale/BitcoinAdult_ru.ts \
                src/qt/locale/BitcoinAdult_sk.ts \
                src/qt/locale/BitcoinAdult_sv.ts \
                src/qt/locale/BitcoinAdult_vi.ts \
                src/qt/locale/BitcoinAdult_zh_CN.ts \
                src/qt/locale/BitcoinAdult_zh_TW.ts
