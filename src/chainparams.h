 ...
 * BTAD system. There are three: the main network on which people trade goods
...
public:
    ...
    int BitcoinAdultBadBlockTime() const { return nBitcoinAdultBadBlockTime; }
    int BitcoinAdultBadBlocknBits() const { return nBitcoinAdultBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nBitcoinAdultBadBlockTime;
    unsigned int nBitcoinAdultBadBlocknBits;
