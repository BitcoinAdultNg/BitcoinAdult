...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BitcoinAdult Core BitcoinAdult-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  BitcoinAdult-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded BitcoinAdult transaction") + "\n" +
                               "  BitcoinAdult-tx [options] -create [commands]   " + _("Create hex-encoded BitcoinAdult transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded BitcoinAdult transaction
