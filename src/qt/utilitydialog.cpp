...
#include "qt/BitcoinAdult/qtutils.cpp"
                                                                    ...
                                                                    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Bitcoin Adult (BTAD) Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
/* On x86 add a bit specifier to the version so that users can distinguish between
    ...
    if (about) {
        setWindowTitle(tr("About Bitcoin Adult (BTAD) Core"));
        ...
        QString header = tr("Usage:") + "\n" +
                         "  BitcoinAdult-qt [" + tr("command-line options") + "]                     " + "\n";
...
ShutdownWindow::ShutdownWindow(QWidget* parent, Qt::WindowFlags f) : QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Bitcoin Adult (BTAD) Core is shutting down...") + "<br /><br />" +
