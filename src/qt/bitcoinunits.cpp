...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case BTAD:
        return QString("BitcoinAdult");
    case mPIV:
        return QString("mBitcoinAdult");
    case uPIV:
        return QString::fromUtf8("uBitcoinAdult");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit, bool isZpiv)
{
    ...
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        switch (unit) {
        case BTAD:
            return z + QString("BTAD");
        case mPIV:
            return z + QString("mBITCOINADULT");
        case uPIV:
            return z + QString::fromUtf8("μBITCOINADULT");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case BTAD:
            return z + QString("tBITCOINADULT");
        case mPIV:
            return z + QString("mtBITCOINADULT");
        case uPIV:
            return z + QString::fromUtf8("μtBITCOINADULT");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case BTAD:
            return QString("BTAD");
        case mPIV:
            return QString("Milli-BTAD (1 / 1" THIN_SP_UTF8 "000)");
        case uPIV:
            return QString("Micro-BTAD (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
