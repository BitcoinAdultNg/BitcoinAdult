...
#include "qt/BitcoinAdult/forms/ui_addresseswidget.h"
#include "qt/BitcoinAdult/addresslabelrow.h"
#include "qt/BitcoinAdult/addnewaddressdialog.h"
...
AddressesWidget::AddressesWidget(BITCOINADULTGUI* parent) :
    PWidget(parent),
    ui(new Ui::AddressesWidget)
{
    ...
    // Address
    ui->labelAddress->setText(tr("Enter a BTAD address"));
