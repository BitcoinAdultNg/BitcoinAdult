...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, BITCOINADULTGUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, BITCOINADULTGUI *gui, double posX = 3);
