...
#include "qt/BitcoinAdult/forms/ui_topbar.h"
#include <QPixmap>
#include "qt/BitcoinAdult/lockunlock.h"
#include "qt/BitcoinAdult/qtutils.h"
#include "qt/BitcoinAdult/receivedialog.h"
...
TopBar::TopBar(BITCOINADULTGUI* _mainWindow, QWidget *parent) :
