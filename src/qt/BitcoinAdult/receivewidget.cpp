...
#include "qt/BitcoinAdult/forms/ui_receivewidget.h"
...
#include "qt/BitcoinAdult/addressholder.h"
...
ReceiveWidget::ReceiveWidget(BITCOINADULTGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive BTAD."));
