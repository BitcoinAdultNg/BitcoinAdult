...
#include <QWidget>
#include <QString>
#include "qt/BitcoinAdult/prunnable.h"
...
class PWidget : public QWidget, public Runnable
{
    Q_OBJECT
public:
    explicit PWidget(BITCOINADULTGUI* _window = nullptr, QWidget *parent = nullptr);
    explicit PWidget(PWidget *parent = nullptr);

    void setClientModel(ClientModel* model);
    void setWalletModel(WalletModel* model);

    BITCOINADULTGUI* getWindow() { return this->window; }
...
protected:
    BITCOINADULTGUI* window = nullptr;
