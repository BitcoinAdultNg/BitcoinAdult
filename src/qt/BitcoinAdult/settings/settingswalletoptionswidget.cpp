...
#include "qt/BitcoinAdult/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/BitcoinAdult/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(BITCOINADULTGUI* _window, QWidget *parent) :
