...
#include "qt/BitcoinAdult/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/BitcoinAdult/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(BITCOINADULTGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to BITCOINADULTGUI::handleRestart()
