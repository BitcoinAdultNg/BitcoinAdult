...
#include "qt/BitcoinAdult/settings/settingsnetworkwidget.h"
#include "qt/BitcoinAdult/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/BitcoinAdult/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(BITCOINADULTGUI* _window, QWidget *parent) :
