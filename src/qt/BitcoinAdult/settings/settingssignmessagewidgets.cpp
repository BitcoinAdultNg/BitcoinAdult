...
#include "qt/BitcoinAdult/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(BITCOINADULTGUI* _window, QWidget *parent) :
