...
#include "qt/BitcoinAdult/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/BitcoinAdult/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(BITCOINADULTGUI* _window, QWidget *parent) :
    ...
    ui(new Ui::SettingsConsoleWidget)
{
    ...
    //Short-Cuts
    keyCtrlD = new QShortcut(_window); // Initialize the object
    keyCtrlD->setKey(Qt::CTRL + Qt::Key_L); // Set the key code
    // connect handler to keypress
    connect(keyCtrlD, SIGNAL(activated()), this, SLOT(slotShortcutCtrlL()));
...
void SettingsConsoleWidget::slotShortcutCtrlL()
{
...
void SettingsConsoleWidget::clear(){
    ...
    message(CMD_REPLY, (tr("Welcome to the BTAD RPC console.") + "<br>" +
