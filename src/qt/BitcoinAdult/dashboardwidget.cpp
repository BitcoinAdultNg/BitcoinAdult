...
#include "qt/BitcoinAdult/forms/ui_dashboardwidget.h"
#include "qt/BitcoinAdult/sendconfirmdialog.h"
#include "qt/BitcoinAdult/txrow.h"
...
DashboardWidget::DashboardWidget(BITCOINADULTGUI* parent) :
    PWidget(parent),
...
void DashboardWidget::loadWalletModel(){
    ...
    // update the display unit, to not use the default ("BTAD")
    updateDisplayUnit();
}
...
bool DashboardWidget::loadChartData(bool withMonthNames) {
    ...
    chartData->amountsByCache = getAmountBy(); // pair BTAD, zBTAD
