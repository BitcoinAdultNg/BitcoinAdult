...
#ifndef BITCOINADULT_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define BITCOINADULT_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //BITCOINADULT_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
