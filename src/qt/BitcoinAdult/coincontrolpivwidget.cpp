...
#include "qt/BitcoinAdult/coincontrolpivwidget.h"
#include "qt/BitcoinAdult/forms/ui_coincontrolpivwidget.h"
    ...
    ui(new Ui::CoinControlPivWidget)
{
    ...
    ui->labelTitle->setText("Select BTAD Outputs to Spend");
    ...
    ui->labelValueAfter->setText("0.00 BTAD");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 BTAD");
    ui->labelValueFee->setText("0.00 BTAD");
