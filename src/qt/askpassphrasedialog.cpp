...
#include "qt/BitcoinAdult/loadingdialog.h"
...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        bool ret = openStandardDialog(
                ...
                tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR BTAD</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
                tr("ENCRYPT"), tr("CANCEL")
        );
        if (ret) {
            if (newpass1 == newpass2) {
                newpassCache = newpass1;
                BITCOINADULTGUI* window = static_cast<BITCOINADULTGUI*>(parentWidget());
...
{
    BITCOINADULTGUI* gui = static_cast<BITCOINADULTGUI*>(parentWidget());
...
{
    hide();
    static_cast<BITCOINADULTGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("BTAD will close now to finish the encryption process. "
