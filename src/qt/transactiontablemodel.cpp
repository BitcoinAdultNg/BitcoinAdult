...
// Copyright (c) 2016-2019 The BITCOINADULT developers
...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::StakeMint:
        return tr("BTAD Stake");
    case TransactionRecord::StakeZPIV:
        return tr("zBTAD Stake");
    case TransactionRecord::StakeDelegated:
        return tr("BTAD Cold Stake");
    case TransactionRecord::StakeHot:
        return tr("BTAD Stake in behalf of");
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted BTAD to zBTAD");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zBTAD");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received BTAD from zBTAD");
    case TransactionRecord::ZerocoinSpend_Change_zPiv:
        return tr("Minted Change as zBTAD from zBTAD Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zBTAD to BTAD");
    default:
        return QString();
    }
}
