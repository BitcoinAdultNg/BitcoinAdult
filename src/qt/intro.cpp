...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Bitcoin Adult (BTAD) Core"),
     ...
     * override -datadir in the BitcoinAdult.conf file in the default data directory
     * (to be consistent with BitcoinAdultd behavior)
     */
