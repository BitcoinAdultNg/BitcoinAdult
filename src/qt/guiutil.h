...
/** Utility functions used by the BTAD Qt UI.
 */
namespace GUIUtil
{
...
// Render BTAD addresses in monospace font
...
// Parse "BitcoinAdult:" URI into recipient object, return true on successful parsing
