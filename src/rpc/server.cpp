...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BTAD features */
        {"BitcoinAdult", "listmasternodes", &listmasternodes, true, true, false},
        {"BitcoinAdult", "getmasternodecount", &getmasternodecount, true, true, false},
        {"BitcoinAdult", "masternodeconnect", &masternodeconnect, true, true, false},
        {"BitcoinAdult", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"BitcoinAdult", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"BitcoinAdult", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"BitcoinAdult", "masternodecurrent", &masternodecurrent, true, true, false},
        {"BitcoinAdult", "masternodedebug", &masternodedebug, true, true, false},
        {"BitcoinAdult", "startmasternode", &startmasternode, true, true, false},
        {"BitcoinAdult", "createmasternodekey", &createmasternodekey, true, true, false},
        {"BitcoinAdult", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"BitcoinAdult", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"BitcoinAdult", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"BitcoinAdult", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"BitcoinAdult", "getmasternodescores", &getmasternodescores, true, true, false},
        {"BitcoinAdult", "preparebudget", &preparebudget, true, true, false},
        {"BitcoinAdult", "submitbudget", &submitbudget, true, true, false},
        {"BitcoinAdult", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"BitcoinAdult", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"BitcoinAdult", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"BitcoinAdult", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"BitcoinAdult", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"BitcoinAdult", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"BitcoinAdult", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"BitcoinAdult", "checkbudgets", &checkbudgets, true, true, false},
        {"BitcoinAdult", "mnsync", &mnsync, true, true, false},
        {"BitcoinAdult", "spork", &spork, true, true, false},
        {"BitcoinAdult", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> BitcoinAdult-cli " + methodname + " " + args + "\n";
}
