/* src/config/btad-config.h.  Generated from btad-config.h.in by configure.  */
/* src/config/btad-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef BTAD_CONFIG_H

#define BTAD_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/TBD"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Bitcoin Adult BTAD Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Bitcoin Adult BTAD Core 1.2.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "BTAD"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://www.Bitcoin-Adult.org/"
