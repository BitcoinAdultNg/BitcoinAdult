...
from test_framework.BitcoinAdult_node import BitcoinAdultTestNode
...
class BITCOINADULT_ColdStakingTest(BitcoinTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(BitcoinAdultTestNode())
...
if __name__ == '__main__':
    BITCOINADULT_ColdStakingTest().main()
